...
<html lang="en">
  ...
  <div class="content">
      ...
      <!-- Testimoni Pelanggan Start-->
      <div class="testimoni">
        <h1 class="judul-testi">Testimoni Pelanggan</h1>
        <h3>Ini kata mereka yang sudah menikmati produk kami.</h3>
        <div class="container-testimoni">
          <img
            src="/image/Testi/J.png"
            alt="J"
            onmouseover="this.src='/image/Testi/1.png'"
            onmouseout="this.src='/image/Testi/J.png'"
          />
          <img
            src="/image/Testi/U.png"
            alt="U"
            onmouseover="this.src='/image/Testi/2.png'"
            onmouseout="this.src='/image/Testi/U.png'"
          />
          <img
            src="/image/Testi/A.png"
            alt="A"
            onmouseover="this.src='/image/Testi/3.png'"
            onmouseout="this.src='/image/Testi/A.png'"
          />
          <img
            src="/image/Testi/R.png"
            alt="R"
            onmouseover="this.src='/image/Testi/5.png'"
            onmouseout="this.src='/image/Testi/R.png'"
          />
          <img
            src="/image/Testi/A.png"
            alt="A"
            onmouseover="this.src='/image/Testi/6.png'"
            onmouseout="this.src='/image/Testi/A.png'"
          />
        </div>
